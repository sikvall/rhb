...
Maximal uteffekt på bandet är 4~W RMS ERP dvs antennvinst överstigande en
...
dag får vilken kanal som helst användas. För just SSB tillåts 12~W ERP.
...
Förr i tiden var kanal 11A en nödkanal. I dag finns ingen passning på denna
frekvens såvitt jag har kunnat utröna.
...
Effekten i tabellen är utstrålad effekt PEP om inte annat anges.
...
Dessa kanaler är markerade med asterisk (*) i tabellen.

\begin{longtable}{rrrrr}
\caption{Splittade duplexkanaler} \\
\textbf{Tidigare} & \textbf{Nytt nr} & \textbf{Frek.} & \textbf{Nytt nr B} & \textbf{Frek.}\\
\hline \endhead

24 & 1024 & 157,200 & 2024 & 161,800 \\
25 & 1025 & 157,250 & 2025 & 161,850 \\
26 & 1026 & 157,300 & 2026 & 161,900 \\
84 & 1084 & 157,225 & 2084 & 161,825 \\
85 & 1085 & 157,275 & 2085 & 161,875 \\
86 & 1086 & 157,325 & 2086 & 161,925 \\
...
VHF Data Exchange System är nästa generations system efter AIS. Det är ett
digital system för kommunikation i det maritima VHF-bandet som gör det
möjligt att skicka betydligt mer data mellan fartyg, kuststationer och
även via satellit.

\subsubsection{Beståndsdelar}

\begin{itemize}
\item AIS -- den vanliga automatiska identifieringssystemet som också
  sänder position, kurs, hastighet och MMSI. Den har högsta prioritet
  och hör till de dagliga säkerhetssystemen.
\item ASM -- application specific messaging -- två dedikerade kanaler
  för specifika meddelanden till exempel väder, varningar och annan
  information. Syftet är att frigöra kapacitet på de vanliga
  AIS-kanalerna för att fler fartyg ska kunna positionera sig oftare.
\item VDE-TER -- VHF Data Exchange terrestrial -- den snabbare
  datalänken mellan fartyg och land samt mellan fartyg. Här används de
  kanaler som tidigare var kanalnummer 24--26 samt 84--85.
\item CTE-SAT -- samma typ av datautbyte men via satellit, vilket ger
  god täckning även utanför kustradions räckvidd.
\end{itemize}

\subsubsection{Funktion}

Systemet använder sig av TDMA (time divition multiple access) dvs man
har tidluckor där olika fartyug kan sända i, precis som AIS men här är
tidluckorna kortare. Skillnaden mot AIS är bland annat:

\begin{itemize}
  \item mer avancerad modulation bland annat $\pi$/4-QPSK, 8PSK och
    16QAM i stället för GSMK som AIS använder sig av
  \item kanalerna kan slås samman till bredare kanaler och ligger
    därför som de ligger, det innebär man kan ta i anspråk 25--150 kHz
    kanalbandbredd beroende på vad som behövs och detta ger förstås
    möjlighet till betydligt högre datahastigheter
  \item meddelanden kan skickas som broadcast till alla i närheten,
    till ett specifikt fartyg, en särskild grupp fartyg eller till ett
    visst geografiskt område
\end{itemize}

Prioriteringsordningen är strikt, först är det AIS, sedan ASM och
därefter VDE-trafiken.

Det finns redan i dag ett antal satelliter i drift från olika
operatörer bl.a. i Danmark, Norge, Portugal, Japan och även Sverige är
med på ett hörn med den svenskbygda YMIR-1 som skjöts upp i november
2023.
...
Flygets VHF använder amplitudmodulation AM och har lite olika
bandbredd beroende på vilken tillämpning man har och vilket syfte
kanalen har. Det förekommer alltså både 25~kHz, 12,5~kHz samt 8,33~kHz
som kanske är lite udda men det är när man delat en 25~kHz kanal i 3.

Användningen av AM är egentligen av två skäl, dels av historiska skäl
eftersom flygradion är en av de äldsta tillämpningarna av
kommunikationsradio på detta frekvensband men också för att om två
sänder samtidigt på FM får en mottagare stor svårighet att särskilja
de båda signalerna och det går inte alls om de är lika starka. AM
däremot så hör man som regel båda rösterna överlagrade och en skicklig
radiooperatör kan därmed lättare förstå vad som sägs vilket ökar
säkerheten.

\begin{longtable}{rlll}
  \caption{Flygfrekvenser VHF sorterade på ort}\\
  \textbf{Frekvens} & \textbf{ort} & \textbf{Län} & \textbf{Benämning} \\ \hline
  \endhead
  121.500 & Hela Sverige & ---             & Nödfrekvens (Guard)             \\
  123.100 & Hela Sverige & ---             & Search \& Rescue (SAR)          \\
  123.450 & Hela Sverige & ---             & Air-to-Air (pilotchat)          \\ \hline
  123.650 & Alingsås     & Västra Götaland & Alingsås Radio                  \\
  116.400 & Alma         & Stockholm       & ALM VOR                         \\
  109.350 & Arlanda      & Stockholm       & ILS 01R                         \\
  109.550 & Arlanda      & Stockholm       & ILS 08                          \\
  109.900 & Arlanda      & Stockholm       & ILS 01L                         \\
  110.100 & Arlanda      & Stockholm       & ILS 26                          \\
  110.700 & Arlanda      & Stockholm       & ILS 19R                         \\
  111.350 & Arlanda      & Stockholm       & ILS 19L                         \\
  116.000 & Arlanda      & Stockholm       & ARL VOR/DME                     \\
  118.505 & Arlanda      & Stockholm       & Arlanda TWR (01L/19R, CTR West) \\
  119.000 & Arlanda      & Stockholm       & Arlanda Arrival ATIS            \\
  121.625 & Arlanda      & Stockholm       & Arlanda Departure ATIS          \\
  121.700 & Arlanda      & Stockholm       & Arlanda GND                     \\
  121.825 & Arlanda      & Stockholm       & Arlanda Clearance Delivery      \\
  121.925 & Arlanda      & Stockholm       & Arlanda GND                     \\
  121.975 & Arlanda      & Stockholm       & Arlanda GND                     \\
  125.130 & Arlanda      & Stockholm       & Arlanda TWR (01R/19L)           \\
  128.730 & Arlanda      & Stockholm       & Arlanda TWR (08/26, CTR East)   \\
  122.730 & Arvidsjaur   & Norrbotten      & Arvidsjaur TWR/AFIS             \\
  112.700 & Backa        & Västra Götaland & BAK VOR/DME                     \\
  123.550 & Backamo      & Västra Götaland & Backamo Traffic                 \\
  123.550 & Borgholm     & Kalmar          & Borglanda Radio                 \\
  117.600 & Borlänge     & Dalarna         & BOR VOR/DME                     \\
  127.305 & Borlänge     & Dalarna         & Borlänge TWR                    \\
  123.525 & Borås        & Västra Götaland & Borås Radio (CTAF)              \\
  118.105 & Bromma       & Stockholm       & Bromma TWR                      \\
  116.800 & Dunker       & Södermanland    & DKR VOR                         \\
  123.425 & Eksjö        & Jönköping       & Eksjö FK Radio                  \\
  126.855 & Eskilstuna   & Södermanland    & Eskilstuna INFO/AFIS            \\
  123.150 & Eslöv        & Skåne           & Eslöv Radio                     \\
  122.100 & Gällivare    & Norrbotten      & Gällivare AFIS                  \\
  124.680 & Göteborg     & Västra Götaland & Göteborg APP/CTL                \\
  122.230 & Hagfors      & Värmland        & Hagfors INFO                    \\
  130.105 & Halmstad     & Halland         & Halmstad TWR                    \\
  117.500 & Harry        & Stockholm       & HAR VOR                         \\
  122.980 & Hemavan      & Västerbotten    & Hemavan TWR/INFO                \\
  123.600 & Hässleholm   & Skåne           & Hässleholm Radio                \\
  123.550 & Höganäs      & Skåne           & Höganäs Traffic                 \\
  115.800 & Jönköping    & Jönköping       & JON VOR/DME                     \\
  118.255 & Jönköping    & Jönköping       & Jönköping TWR                   \\
  111.600 & Kalmar       & Kalmar          & KAL VOR/DME                     \\
  130.805 & Kalmar       & Kalmar          & Kalmar TWR                      \\
  117.800 & Karlstad     & Värmland        & KSD VOR/DME                     \\
  115.200 & Kiruna       & Norrbotten      & KRA VOR/DME                     \\
  130.150 & Kiruna       & Norrbotten      & Kiruna TWR                      \\
  122.155 & Kramfors     & Västernorrland  & Kramfors TWR/AFIS               \\
  129.355 & Kristianstad & Skåne           & Kristianstad TWR                \\
  123.350 & Landskrona   & Skåne           & Landskrona Radio                \\
  110.300 & Landvetter   & Västra Götaland & ILS LOC 03 (SGG)                \\
  114.600 & Landvetter   & Västra Götaland & LAV VOR/DME                     \\
  118.375 & Landvetter   & Västra Götaland & Landvetter ATIS                 \\
  118.605 & Landvetter   & Västra Götaland & Landvetter TWR                  \\
  121.600 & Landvetter   & Västra Götaland & Landvetter Apron                \\
  121.675 & Landvetter   & Västra Götaland & Clearance Delivery              \\
  121.900 & Landvetter   & Västra Götaland & Landvetter GND                  \\
  124.450 & Lidköping    & Västra Götaland & Lidköping AFIS                  \\
  118.805 & Linköping    & Östergötland    & Saab TWR                        \\
  113.400 & Ljungbyhed   & Skåne           & LJU VOR/DME                     \\
  130.705 & Ljungbyhed   & Skåne           & Ljungbyhed TWR                  \\
  115.100 & Luleå        & Norrbotten      & SLU VOR/DME                     \\
  128.205 & Luleå        & Norrbotten      & Kallax TWR                      \\
  121.850 & Malmen       & Östergötland    & Malmen GND                      \\
  129.800 & Malmen       & Östergötland    & Malmen TWR                      \\
  113.000 & Malmö        & Skåne           & SUP VOR/DME                     \\
  118.805 & Malmö        & Skåne           & Sturup TWR                      \\
  129.275 & Malmö        & Skåne           & Sturup ATIS                     \\
  135.900 & Malmö        & Skåne           & Malmö CON/APP                   \\
  129.855 & Mora         & Dalarna         & Mora AFIS                       \\
  123.350 & Oskarshamn   & Kalmar          & Oskarshamn Radio                \\
  118.380 & Pajala       & Norrbotten      & Pajala INFO                     \\
  119.200 & Ronneby      & Blekinge        & Ronneby TWR                     \\
  121.700 & Ronneby      & Blekinge        & Ronneby GND                     \\
  128.450 & Ronneby      & Blekinge        & Ronneby CON/TCA                 \\
  126.280 & Skavsta      & Södermanland    & Skavsta ATIS                    \\
  127.705 & Skavsta      & Södermanland    & Skavsta TWR                     \\
  113.400 & Skellefteå   & Västerbotten    & SKA VOR/DME                     \\
  122.055 & Skellefteå   & Västerbotten    & Skellefteå TWR                  \\
  123.750 & Stockholm    & Stockholm       & Stockholm Control / APP         \\
  116.300 & Storuman     & Västerbotten    & SUM VOR/DME                     \\
  123.550 & Strömstad    & Västra Götaland & Strömstad Traffic               \\
  113.100 & Sundsvall    & Västernorrland  & SUN VOR/DME                     \\
  127.400 & Sundsvall    & Västernorrland  & Sundsvall ATIS                  \\
  129.555 & Sundsvall    & Västernorrland  & Sundsvall TWR                   \\
  123.200 & Sunne        & Värmland        & Sunne Traffic                   \\
  122.200 & Sveg         & Jämtland        & Sveg AFIS/INFO                  \\
  119.055 & Säve         & Västra Götaland & Säve TWR                        \\
  123.650 & Sövde        & Skåne           & Sövde Radio                     \\
  117.100 & Tebby        & Stockholm       & TEB VOR/DME                     \\
  118.205 & Tierp        & Uppsala         & Sweden Control (sektor)         \\
  123.400 & Tierp        & Uppsala         & Tierp Radio                     \\
  122.055 & Torsby       & Värmland        & Torsby INFO                     \\
  122.725 & Trollhättan  & Västra Götaland & Trollhättan TWR                 \\
  114.300 & Trosa        & Södermanland    & TRS VOR/DME                     \\
  123.550 & Uddevalla    & Västra Götaland & Uddevalla Traffic               \\
  114.100 & Umeå         & Västerbotten    & UME VOR/DME                     \\
  119.805 & Umeå         & Västerbotten    & Umeå TWR                        \\
  119.200 & Uppsala      & Uppsala         & Uppsala TWR                     \\
  130.400 & Uppsala      & Uppsala         & Uppsala APP                     \\
  134.200 & Uppsala      & Uppsala         & Stockholm TCA                   \\
  122.555 & Vilhelmina   & Västerbotten    & Vilhelmina INFO                 \\
  115.100 & Visby        & Gotland         & VSB VOR/DME                     \\
  120.305 & Visby        & Gotland         & Visby TWR                       \\
  112.800 & Västerås     & Västmanland     & ARS VOR/DME                     \\
  130.605 & Västerås     & Västmanland     & Västerås TWR                    \\
  118.155 & Växjö        & Kronoberg       & Växjö/Kronoberg TWR             \\
  127.105 & Ängelholm    & Skåne           & Ängelholm TWR                   \\
  120.280 & Örebro       & Örebro          & Örebro TWR                      \\
  115.000 & Örnsköldsvik & Västernorrland  & OSK VOR/DME                     \\
  122.255 & Örnsköldsvik & Västernorrland  & Örnsköldsvik AFIS               \\
  114.650 & Östersund    & Jämtland        & OSS VOR/DME                     \\
  135.655 & Östersund    & Jämtland        & Östersund TWR                   \\
  132.955 & Östergötland & Östergötland    & Östgöta APP                     \\
  \end{longtable}
...
Även kortvåg används för flyget och här är några exempel, det finns
dock fler frekvenser än dessa som är i bruk.

HN = natt, HJ = dagtid, H24 alltid. Primära frekvenser markerade med *.

\begin{table}[H]
\centering
\caption{VOLMET på HF (ingår inte i NAT-/EUR-familjerna)}
\label{tab:hf-volmet}
\small
\begin{tabular}{@{}llll@{}}
\hline
\textbf{Station} & \textbf{HN} & \textbf{H24} & \textbf{HJ} \\
\hline
Shannon VOLMET
  & 3413 & 5505, 8957 & 13264 \\
New York / Gander VOLMET
...
\begin{table}[H]
\centering
\caption{Flygets HF-frekvenser, NAT-familjer och EUR-MWARA}
\begin{tabular}{@{}lllp{55mm}@{}}
\hline
\textbf{Område} & \textbf{Familj} & \textbf{Frekvenser (kHz)} & \textbf{Anmärkning} \\
\hline
NAT & A
  & 3016, 5598, 8906, 13306, 17946
  & Södra rutterna ca 43N--47N.
    Gander, New York, Santa Maria, Shanwick \\
NAT & B
  & 2899, 5616, 8864, 13291, 17946
  & Centrala rutter 47N--64N.
...
NAT & C
  ...
  & Centrala rutter 47N--64N.
    Gander, Iceland, Shanwick \\
NAT & D
  & 2971, 4675, 8891, 11279, 13291, 17946
  & Norra rutter över 62°N som tex
    Bodø, Gander, Iceland, Shanwick \\
NAT & E
  & 2962, 6628, 8825, 11309, 13354, 17946
  & Taktisk tilldelning NY/Santa Maria.
    13354 delas med RDARA 5 och 7 \\
NAT & F
  & 3476, 6622, 8831, 13291, 17946
  & Taktisk, Gander/Shanwick \\
\hline
EUR & A
...
Delade NAT-frekvenser: 13306~(A+C), 13291~(B+D+F), 17946~(alla familjer A--F).
Familj~H (RDARA, Santa Maria FIR) är 3491 och 6667~kHz och hör inte till MWARA-familjerna ovan.

Typisk bandanvändning (ITU App.~27 / NAT Doc~003):
3 och 6,6~MHz natt (HN), 5,6~MHz oftast H24, 9 och 11,3~MHz dag (HJ),
13~MHz och högre dag eller efter behov (HO).
Exakt passning styrs av Shanwick/Gander efter utbredning, inte av fasta stjärnmarkeringar.


\subsection{Stockholm Radio HF flygfrekvenser}

\begin{longtable}{rcll}
  \textbf{Frekv. [kHz]} &
  \textbf{Mode}         &
  \textbf{Tider} &
  \textbf{Beskrivning} \\ \hline
  \endhead

 3494 & USB & Natt    & Kort/medellång räckvidd             \\
 5541 & USB & H24     & Dag: kort räckvidd; natt: lång      \\
 8930 & USB & H24     & Dag: medellång räckvidd; natt: lång \\
11345 & USB & H24     & Medellång/lång räckvidd             \\
13342 & USB & H24     & Medellång/lång räckvidd             \\
17916 & USB & H24/Dag & Lång räckvidd                       \\
23210 & USB & Dag     & Mycket lång räckvidd                \\
  \caption{Stockholm Radio (STORADIO) HF-frekvenser}                                   \\
\end{longtable}
...
Repeater & FM         & SK5BB/R  & Arboga/Kolsva        &     434.8750 &     -2.000 & Carrier           & JP79WO      & QRV      \\
	...
	Repeater          & ATV        & SK5BN/R  & Norrköping/Kolmården &    1282.0000 &    -30.000 &                   & JO88FQ      & QRV      \\
