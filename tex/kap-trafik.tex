...
Vi pratar inte \textbf{nedvärderande} om personer vare sig de är andra amatörer
...
Sverige följande signalserier: 7SA--7SZ samt 8SA--8SZ och vidare de mer kända
...
på engelska är det vanligare att man uttalar CQ (seek you). Ett allmänt anrop
kan se ut såhär:
...
\begin{tabular}{lrl}
	\textbf{Station} & \textbf{Frekvens} & \textbf{Meddelande}                     \\ \hline
...
Du deltar i en tävling där man skall ange signalrapport och löpnumret från
start av tävlingen på den kontakt du har. Du har hitintills kontaktat 30
stationer i tävlingen. Du har hittat en ledig frekvens och ropar CQ.

\begin{tabular}{ll}
	\textbf{Station} & \textbf{Meddelande}                       \\ \hline
...
Den stora fördelen med morsesignalering är att bandbredden blir mycket låg och
