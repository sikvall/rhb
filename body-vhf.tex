...
\footnotesize
\begin{itemize}
	\item[$^M$] Delas med marina VHF-bandet, kanalerna L1 och L2
          för fritidsbåtar.
	\item[$^P$] PMR-kanal som kan användas till vad som helst så
          länge det är landmobil radio och effekten ej överskrids.
\end{itemize}
\normalsize
...
\item För 2m-bandet är FM-kanaler endast definierade från 145 MHz och
  uppåt.
\item I 70 cm-bandet är inga kanaler definierade i intervallet
  432.000--433.000 MHz. Observera att startfrekvensen är utanför 70cm
  bandplanen i IARU region 1.
\end{itemize}

OBS!\\ Information om kanalnumreringen för 23cm-bandet tas tacksamt
