...
%Amatörer som fått sitt certifikat tilldelat av Televerket eller senare Post- och Telestyrelsen har signaler i serien SM0AAA-SM7ZZZ för vanliga distrikt. SM8 förekommer också men då är det särskilda stationer utanför rikets gränser. Efter att SSA, ESA och FRO började utdela signaler sker utdelningen i SA0AAA--SA7ZZZ i stället.
%
%Klubbar har signaler i serien SK0AA--SK0ZZ. Militära stationer återfinns i serien SL0AA-SL8AA där distrikt 8 kan vara militära skepp.
%
%Repeatrar har ofta samma signal som klubben som driver den, eller en enskild amatör med tillägget /R enligt nedan.
%
%\begin{tabular}{llllll}
%/R & Repeater\\
%/M & Mobil\\
%/MM & Mobil Maritim (till sjöss)\\
%/AM & Aeromobil (luftfarkost)\\
%\end{tabular}
%
%\subsection{Norska signaler}
%
%\subsection{Danska signaler}
%
%\subsection{Finska signaler}
